                ...
                <div class="uk-card uk-card-default uk-width-1-2@m ">
                    <div class="uk-card-header">
                            <div class="uk-text-right uk-margin">
                                    <button id='detail'class="uk-button uk-button-primary uk-button-default " type="button" uk-toggle="target: #modal-cahngePwd">Change Password</button>
                            </div>
                        <div class="uk-grid-small uk-flex-middle" uk-grid>
                            
                            <div class="uk-width-auto">
                                
                                <img class="uk-comment-avatar" width="200" height="200" src="./image/user.png">
                            </div>
                            <div class="uk-width-expand">
                                <h3 class="uk-card-title uk-margin-remove-bottom"><?php echo $user['name'];?></h3>
                                <p class="uk-text-meta uk-margin-remove-top"><?php echo $user['role']?></p>
                    ...
                    <div class="uk-card-body">
                            <div class="uk-text-right uk-margin">
                                    <button id='detail'class="uk-button uk-button-default " type="button" uk-toggle="target: #modal-Into">Modify</button>
                            </div>
